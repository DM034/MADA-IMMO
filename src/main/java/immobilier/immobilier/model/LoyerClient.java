...
public class LoyerClient {
    ...
    public String formatMontant(){
        return Tools.formatThousand(montant);
    }

    public LinkedList<LoyerClient> getLoyerClientDouble1erMoisEntre2Dates(String idClient, String date1, String date2, Connection con)
            throws Exception {
    ...
    public LinkedList<LoyerClient> getLoyerClientDouble1erMoisAPayerEntre2Dates(String idClient, String date1, String date2, Connection con)
            throws Exception {
        LinkedList<LoyerClient> result = new LinkedList<LoyerClient>();
        boolean open = false;
        if (con == null) {
    ...
    public LinkedList<LoyerClient> getLoyerClientDouble1erMoisPayeEntre2Dates(String idClient, String date1, String date2, Connection con)
            throws Exception {
        LinkedList<LoyerClient> result = new LinkedList<LoyerClient>();
        boolean open = false;
        if (con == null) {
    ...
    public LoyerClient(String idClient, String client, String idProprio, String proprio, String idBiens, String biens, String region, String type, String idLocation, String date, Double montant, String statut_paiement,String row_num) {
        this.idClient = idClient;
        this.client = client;
        this.idProprio = idProprio;
        this.proprio = proprio;
